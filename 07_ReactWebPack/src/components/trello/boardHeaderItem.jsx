...
class BoardHeaderItem extends React.Component {
    ...
    renderForm() {
        return (
            <div className="card col-3 text-center" key="CreateNewElement">
                <div className="card-body">
                    ...
                    <input type="button" className="btn btn-primary btn-sm" value="Save"
        ...
        return (
            <div className="card col-3 text-center" key="CreateNewElement">
                <div className="card-body" onClick={this.openEditForm.bind(this)}>
                    <a className="btn btn-primary">Создать</a>
                </div>
            </div>
        );
    }
