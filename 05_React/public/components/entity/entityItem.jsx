class EntityItem extends React.Component {
        ...
        return (
            <div className="card col-3" key="CreateNewElement">
                <div className="card-body">
                    ...
                    <input name="name" type="text" value={this.state.item.name} onChange={this.onChange.bind(this)}/>
    ...
    openEditForm() {
        this.oldItem = JSON.stringify(this.state.item);//Сохраняю старый элемент (null)
        if (this.state.item == null) {
            this.state.item = new Object();
            this.state.item.name = "";
        }//Если у меня создание нового элемента - то делаю чистый
